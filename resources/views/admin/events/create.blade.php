    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_instruction') ? 'is-invalid' : '' }}" type="text" name="link_instruction" id="link_instruction" value="{{ old('link_instruction', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pixel') ? 'is-invalid' : '' }}" type="text" name="pixel" id="pixel" value="{{ old('pixel', '') }}">
                @if($errors->has('pixel'))
                    <div class="invalid-feedback">
                        {{ $errors->first('pixel') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('whatsappmessage') ? 'is-invalid' : '' }}" name="whatsappmessage" id="whatsappmessage">{{ old('whatsappmessage') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whatsapp_help') ? 'is-invalid' : '' }}" type="text" name="whatsapp_help" id="whatsapp_help" value="{{ old('whatsapp', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::VISUALIZATION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('visualization') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="visualization_{{ $key }}" name="visualization" value="{{ $key }}" {{ old('visualization', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::ALLOW_GUESTS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('allow_guests') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="allow_guests_{{ $key }}" name="allow_guests" value="{{ $key }}" {{ old('allow_guests', '1') === (string) $key ? 'checked' : '' }}>
